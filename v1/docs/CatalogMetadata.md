...
**UpdateTimestamp** | Pointer to **string** | Timestamp when the Catalog was updated the last time | [optional] 
**Uid** | Pointer to **string** | Unique identifier of the Catalog | [optional] 
**Labels** | Pointer to **map[string]string** | Labels of the Catalog | [optional] 
**Annotations** | Pointer to **map[string]string** | Annotations of the Catalog | [optional] 
