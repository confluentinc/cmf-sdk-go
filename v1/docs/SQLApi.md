...
> DeleteComputePool(ctx, envName, computePoolName).Force(force).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SQLApi.DeleteComputePool(context.Background(), envName, computePoolName).Force(force).Execute()
    if err != nil {
...
> DeleteStatement(ctx, envName, stmtName).Force(force).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SQLApi.DeleteStatement(context.Background(), envName, stmtName).Force(force).Execute()
    if err != nil {
...
> ComputePoolsPage GetComputePools(ctx, envName).Page(page).Size(size).Sort(sort).Filter(filter).IncludeResourceInformation(includeResourceInformation).Fields(fields).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SQLApi.GetComputePools(context.Background(), envName).Page(page).Size(size).Sort(sort).Filter(filter).IncludeResourceInformation(includeResourceInformation).Fields(fields).Execute()
    if err != nil {
...
> StatementsPage GetStatements(ctx, envName).Page(page).Size(size).Sort(sort).ComputePool(computePool).Phase(phase).IncludeResourceInformation(includeResourceInformation).Filter(filter).Search(search).SearchScope(searchScope).Fields(fields).Name(name).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SQLApi.GetStatements(context.Background(), envName).Page(page).Size(size).Sort(sort).ComputePool(computePool).Phase(phase).IncludeResourceInformation(includeResourceInformation).Filter(filter).Search(search).SearchScope(searchScope).Fields(fields).Name(name).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SQLApi.UpdateComputePool(context.Background(), envName, computePoolName).ComputePool(computePool).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `SQLApi.UpdateComputePool``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `UpdateComputePool`: ComputePool
    fmt.Fprintf(os.Stdout, "Response from `SQLApi.UpdateComputePool`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUpdateComputePoolRequest struct via the builder pattern
