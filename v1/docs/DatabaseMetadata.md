...
**CreationTimestamp** | Pointer to **string** | Timestamp when the Database was created | [optional] 
**UpdateTimestamp** | Pointer to **string** | Timestamp when the Database was updated the last time | [optional] 
**Uid** | Pointer to **string** | Unique identifier of the Database | [optional] 
**Labels** | Pointer to **map[string]string** | Labels of the Database | [optional] 
**Annotations** | Pointer to **map[string]string** | Annotations of the Database | [optional] 
...
### NewDatabaseMetadataWithDefaults
