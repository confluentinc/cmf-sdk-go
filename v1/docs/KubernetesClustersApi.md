...
------------- | ------------- | -------------
[**GetKubernetesCluster**](KubernetesClustersApi.md#GetKubernetesCluster) | **Get** /cmf/api/v1/kubernetes-clusters/{kubernetesClusterName} | Retrieve a Kubernetes cluster by name.
[**GetKubernetesClusters**](KubernetesClustersApi.md#GetKubernetesClusters) | **Get** /cmf/api/v1/kubernetes-clusters | Retrieve a list of all registered Kubernetes clusters.
[**UpdateKubernetesCluster**](KubernetesClustersApi.md#UpdateKubernetesCluster) | **Put** /cmf/api/v1/kubernetes-clusters/{kubernetesClusterName} | Update a Kubernetes cluster (lifecycle state, labels, annotations).



## GetKubernetesCluster

> KubernetesCluster GetKubernetesCluster(ctx, kubernetesClusterName).Execute()
...
func main() {
    kubernetesClusterName := "kubernetesClusterName_example" // string | Name of the Kubernetes cluster

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.KubernetesClustersApi.GetKubernetesCluster(context.Background(), kubernetesClusterName).Execute()
    if err != nil {
...
> KubernetesClustersPage GetKubernetesClusters(ctx).Page(page).Size(size).Sort(sort).Filter(filter).Fields(fields).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.KubernetesClustersApi.GetKubernetesClusters(context.Background()).Page(page).Size(size).Sort(sort).Filter(filter).Fields(fields).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `KubernetesClustersApi.GetKubernetesClusters``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `GetKubernetesClusters`: KubernetesClustersPage
...
[**KubernetesClustersPage**](KubernetesClustersPage.md)
...
> KubernetesCluster UpdateKubernetesCluster(ctx, kubernetesClusterName).KubernetesCluster(kubernetesCluster).Execute()
...
func main() {
    kubernetesClusterName := "kubernetesClusterName_example" // string | Name of the Kubernetes cluster
    kubernetesCluster := *openapiclient.NewKubernetesCluster("ApiVersion_example", "Kind_example", *openapiclient.NewKubernetesClusterMetadata("Name_example"), *openapiclient.NewKubernetesClusterSpec()) // KubernetesCluster | 

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.KubernetesClustersApi.UpdateKubernetesCluster(context.Background(), kubernetesClusterName).KubernetesCluster(kubernetesCluster).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `KubernetesClustersApi.UpdateKubernetesCluster``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `UpdateKubernetesCluster`: KubernetesCluster
    fmt.Fprintf(os.Stdout, "Response from `KubernetesClustersApi.UpdateKubernetesCluster`: %v\n", resp)
}
```
