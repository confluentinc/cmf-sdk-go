...
> SavepointsPage GetSavepointsForFlinkApplication(ctx, envName, appName).Page(page).Size(size).Sort(sort).Filter(filter).Fields(fields).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SavepointsApi.GetSavepointsForFlinkApplication(context.Background(), envName, appName).Page(page).Size(size).Sort(sort).Filter(filter).Fields(fields).Execute()
    if err != nil {
...
> SavepointsPage GetSavepointsForFlinkStatement(ctx, envName, stmtName).Page(page).Size(size).Sort(sort).Filter(filter).Fields(fields).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.SavepointsApi.GetSavepointsForFlinkStatement(context.Background(), envName, stmtName).Page(page).Size(size).Sort(sort).Filter(filter).Fields(fields).Execute()
    if err != nil {
